 ...
 <CookieBanner />
   <!-- content devision -->
 <div class=" h-auto  z-50  text-center text-gray-950 px-5 lg:px-20 py-1">
<!-- Call To Action (CTA) -->
...
<section class="bg-white select-none">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 h-auto">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 class="mb-4 text-5xl tracking-tight font-bold text-gray-950  ">Discover Top Course</h2>
      ...
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0  ">
          <!-- Pricing Card -->
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-950  duration-500 bg-white rounded-lg border border-gray-300 hover:shadow-xl ">
              ...
              <a href="#" class="text-white bg-gray-950 hover:bg-blue-600 duration-500 focus:ring-4 focus:ring-primary-200 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Get started</a>
          </div>
          <!-- Pricing Card -->
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-950 bg-white rounded-lg border duration-500  xl:p-8 border-gray-300 hover:shadow-xl">
              ...
              <a href="#" class="text-white bg-gray-950 duration-500 hover:bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">Get started</a>
          </div>
          <!-- Pricing Card -->
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-black bg-white rounded-lg border duration-500  xl:p-8 border-gray-300 hover:shadow-xl">
